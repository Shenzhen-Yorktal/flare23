...
if __name__ == "__main__":
    ...
    try:
        ...
        # )
        cmd = 'docker container run --shm-size=28gb -m 28G --gpus="device=0" --name {} --rm -v $PWD/inputs/:/workspace/inputs/ -v $PWD/outputs/:/workspace/outputs/ {}:latest /bin/bash -c "sh predict.sh" '.format(args.docker_name, args.docker_name)
